...
2.  In the **Manage Members** dialog box, select one of the following options, and then click **Continue**.  
  ...
  > [!NOTE]
  >  A marketing list can contain upto a maximum of 150,000 members. Consider upgrading to the Sales Enterprise app if you need to add  additional members per list.
